...
public class SourcePanel extends Application {
    ...
    private VBox makeToolPanel(Canvas canvas) {
        ...
        image = new Image(rectangleImage);
        imageView = new ImageView(image);
        Button rectButton = new Button("", imageView);
        rectButton.setOnAction((e) -> addShape(new RectangleShape(), 10, 150, 100, 75));
    ...
    private void mouseClicked(MouseEvent evt) {
        ...
        if (currentShape.toString().contains("Oval"))
            ...
            addShape(new RectangleShape(), (int) evt.getX(), (int) evt.getY(), 100, 75);
